...
!!! note "How submissions are handled"
    Nothing publishes automatically. A reviewer removes names, patient information, and any phrasing that reads as a factual charge against a third party, then publishes the lesson as your account. Organizations stay anonymous unless they choose to be named.
