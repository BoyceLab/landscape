...
- [Approach and rubric](approach.md) — methodology, roles, rubric, and timeline.
- [Running a session](facilitator-guide.md) — a script for the 60–90 minute session.
- [For testers](welcome-packet.md) — what testers receive before their session.
- [Outreach templates](outreach.md) — recruitment emails for each audience.
- [Task bank](task-bank.md) — realistic tasks to give testers.
- [Feedback form](feedback-form.md) — standalone form for testers to complete.
- [Synthesis and release](synthesis.md) — templates for what comes after testing.
